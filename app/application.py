...
class Application:
    ...
    def open_folder(self, directory=None, pick_up_where_left_off=True):
        ...
        # If no directory is passed to function, ask user to select
        if not directory: directory = fd.askdirectory(initialdir = dirname(getcwd()))
    ...
    def assess_folder(self):
        ...
        self.assess_file = fd.asksaveasfilename(
            initialdir = dirname(getcwd()),
            title = 'Select filename for assessment results file',
        ...
        #self.open_folder(
        #    directory = '/Users/tessa/Code/detect-towhee/squiggle-detector/app/recordings',
